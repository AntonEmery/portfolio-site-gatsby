...
class About extends Component {
  ...
  render() {
    return (
      <Layout>
        <div>
          <img src="/img/avatar.jpg" className="about-image" alt="anton headshot" />
          ...
          <p>I play irish and old time music on guitar, banjo, and flute. I released a <a href="http://www.celticfingerstyleguitar.com" target="_blank" rel="noopener noreferrer" className="text-link">solo cd</a> in 2010, play a lot of music with friends, and perform occasionally at house concerts and other events around the Northwest.</p>
