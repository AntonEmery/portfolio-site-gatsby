  ...
  return (
    <Layout>
      <div>
        ...
        <h2>Projects</h2>
        <p>I wish I had more time to work on more cool projects after work. Below are some examples of things I have done. Check out my <a href="http://www.github.com/antonemery" target="_blank" class="text-link">Github</a> as well for more recent work. </p>
